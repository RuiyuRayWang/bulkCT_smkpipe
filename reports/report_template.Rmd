...
frip_file <- paste0(proj_path, "/peakCalling/deeptools/", params$sample, "_frip.txt")
frip_score <- read.table(frip_file, header = FALSE, fill = TRUE)$V2
...
qc_metrics <- list(
  ...
  peak_type = paste0("top", params$seacr_cutoff),
